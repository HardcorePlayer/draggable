        ...
        init: function(node, option) {
            ...
            if (option) {
                if (option.axis === axis.x) {
                    mask.addEventListener('mousemove', active(function(e) {
                        // 计算移动偏移
            ...
            mask.addEventListener('mouseleave', cancel);
            mask.addEventListener('mouseup'   , cancel);
        },
